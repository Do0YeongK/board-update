...
export default function Main() { 
    ...
    return(
      <div className='main-top'>
        <div className='main-top-text-container'>
          <div className='main-top-text'>Dori board에서</div>
  ...
  const MainBottom = () => {
    ...
    const {totalPage, currentPage, currentSection, 
            onPageClickHandler, onPreviousClickHandler, onNextClickHandler, changeSection} = usePagination();
