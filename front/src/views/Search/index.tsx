...
import { COUNT_BY_PAGE, MAIN_PATH } from 'src/constants';
import './style.css';
...
export default function Search() {
  ...
  //  description: 페이지네이션과 관련된 상태 및 이벤트 함수  //
  ...
  // description: 검색 결과 리스트 불러오기 응담 처리 함수 //
  ...
  //  description: 현재 페이지가 바뀔 때 마다 게시물 분류하기 //
  useEffect(() => {
