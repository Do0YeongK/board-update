...
public class SearchController {
  ...
  public ResponseEntity<? super GetRelationListResonseDto> getRelationList(
    @PathVariable(value = "searchWord", required = true) String searchWord
  ) {
    ResponseEntity<? super GetRelationListResonseDto> response = searchService.getRelationList(searchWord);
    return response;
  }
