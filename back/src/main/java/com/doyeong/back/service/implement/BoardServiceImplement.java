...
import com.doyeong.back.dto.response.board.BoardListResponseDto;
import com.doyeong.back.dto.response.board.CommentListResponseDto;
import com.doyeong.back.dto.response.board.DeleteBoardResponseDto;
import com.doyeong.back.dto.response.board.FavoriteListResponseDto;
...
import com.doyeong.back.repository.BoardRepository;
import com.doyeong.back.repository.BoardViewRepository;
import com.doyeong.back.repository.CommentRepository;
import com.doyeong.back.repository.FavoriteRepository;
import com.doyeong.back.repository.SearchLogRepository;
import com.doyeong.back.repository.UserRepository;
import com.doyeong.back.service.BoardService;
...
public class BoardServiceImplement implements BoardService {
  ...
  public ResponseEntity<? super GetSearchBoardResponseDto> getSearchBoard(String searchWord, String relationWord) {
    ...
    try{
      ...
      /* 2023-08-14 인기검색어 리스트 부르기 위해 삭제
  ...
  public ResponseEntity<? super GetFavoriteListResponseDto> getFavoriteList(Integer boardNumber) {
    ...
    try {
      ...
      // description: 해당 게시물의 좋아요 리스트 조회 //
  ...
  @Override
  public ResponseEntity<? super PostBoardResponseDto> postBoard(String writeEmail, PostBoardRequestDto dto) {
    
    try {
      // description: 작성자 이메일이 존재하는 이메일인지 확인 //
      boolean hasUser = userRepository.existsByEmail(writeEmail);
      if (!hasUser) return PostBoardResponseDto.noExistedUser();

      // description: entity 생성 //
      BoardEntity boardEntity = new BoardEntity(writeEmail, dto);
  ...
  public ResponseEntity<? super PutFavoriteResponseDto> putFavorite(Integer boardNumber, String userEmail) {
    ...
    try {
      // description: boardNumber가 null인지 확인 //
